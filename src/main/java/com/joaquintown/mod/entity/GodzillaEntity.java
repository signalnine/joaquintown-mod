...
public class GodzillaEntity extends HostileEntity implements GeoEntity {
    ...
    private static final TrackedData<Boolean> BABY = DataTracker.registerData(GodzillaEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final Ingredient BREEDING_INGREDIENT = Ingredient.ofItems(ModItems.SEAWEED_WRAP);
    ...
    public float getSoundPitch() {
        // Baby Godzillas have higher pitched sounds (1.5x higher)
    ...
    /**
     * Check if the given item can be used to breed Godzilla.
     */
    ...
    /**
     * Handle player interaction - feeding seaweed wraps to breed.
     */
    @Override
    ...
    /**
     * Set Godzilla into love mode (ready to breed).
     */
    ...
    /**
     * Check if Godzilla is in love mode.
     */
    ...
    public void tick() {
        ...
        if (this.isInLove()) {
            ...
            // Try to breed with nearby Godzilla in love mode
    ...
    /**
     * Try to find another Godzilla in love mode and breed.
     */
    private void tryToBreed() {
        ...
        // Find nearby Godzillas in love mode
        var nearbyGodzillas = serverWorld.getEntitiesByClass(
            GodzillaEntity.class,
            this.getBoundingBox().expand(8.0),
            other -> other != this && other.isInLove() && !other.isBaby()
        );

        if (!nearbyGodzillas.isEmpty()) {
            GodzillaEntity mate = nearbyGodzillas.get(0);

            // Create baby Godzilla
    ...
    /**
     * Breed with another Godzilla and create a baby.
     */
    private void breed(ServerWorld world, GodzillaEntity mate) {
        GodzillaEntity baby = ModEntities.GODZILLA.create(world);
        if (baby != null) {
            baby.setBaby(true);
    ...
    /**
     * Check if this Godzilla is a baby.
     */
    ...
    /**
     * Set whether this Godzilla is a baby.
     */
